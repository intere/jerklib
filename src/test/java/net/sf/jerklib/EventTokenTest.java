...
public class EventTokenTest
{
	...
	public void parseTest1()
	{
		...
		assertTrue(eventToken.prefix() , eventToken.prefix().equals("kubrick.freenode.net"));
		
		assertTrue(eventToken.command().equals("353"));
	...
	public void parseTest2()
	{
		...
		assertTrue(eventToken.prefix() , eventToken.prefix().equals("NeWtoz!jimmy@nix-2F996C9F.dhcp.aldl.mi.charter.com"));
		
		assertTrue(eventToken.command().equals("PRIVMSG"));
	...
	public void parseTest3()
	{
		...
		assertTrue(eventToken.prefix() , eventToken.prefix().equals(""));
		
		assertTrue(eventToken.command().equals("PING"));
