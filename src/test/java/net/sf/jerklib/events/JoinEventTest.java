...
public class JoinEventTest extends EventTestBase
{
	...
	{
		//this is the amount of events in the text file minus 4
		// the -4 are JOIN_COMPLETE events , not dispatched as a JOIN
		assertTrue(events.size() + "" , events.size() == 5688);
	}
	
	
	/*
	 * The index of all events for this test
	 * is -4 from actual index in file due to 
	 * the first 4 events being JOIN_COMPLETE events
	 */
